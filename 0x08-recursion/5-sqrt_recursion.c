 ...
 *
 * This function takes an integer 'n' and recursively calculates
 ...
 * it recursively computes the square root using a binary search
 * approach until it finds the closest integer
 ...
 *
 * This recursive helper function implements a binary search approach
 * to calculate the square root of 'n'. It uses a guess that starts at
 * 1 and iteratively improves
